...
SET PATH=C:\Users\Alex\Box Sync\Research\qtlab-master\3rd_party\gnuplot\bin;%PATH%

:: Add Console2 to PATH
SET PATH=C:\Users\Alex\Box Sync\Research\qtlab-master\3rd_party\Console2\;%PATH%
